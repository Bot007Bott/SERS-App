...
/**
 * TeacherSettingsFragment — MVVM View
 * Uses ProfileViewModel for user info and account management.
 */
class TeacherSettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.user.observe(viewLifecycleOwner) { user ->
            ...
            binding.tvAvatar.text = user.firstName.firstOrNull()?.uppercase() ?: "T"
